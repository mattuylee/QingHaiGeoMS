...
export let BASE_URL = 'http://60.205.187.71:8088'
@Injectable({
    providedIn: 'root'
})
export class ApiService {
    ...
    private statisticDataCache  //统计数据缓存
    private user = {
        id: '1'
    } as any
    /**@deprecated */
